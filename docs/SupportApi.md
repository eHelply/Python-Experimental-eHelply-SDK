# ehelply_python_experimental_sdk.SupportApi
...
from ehelply_python_experimental_sdk.api import support_api
...
with ehelply_python_experimental_sdk.ApiClient(configuration) as api_client:
    ...
    path_params = {
        ...
        'member_uuid': "member_uuid_example",
    }
    header_params = {
    }
    body = CreateTicket(
