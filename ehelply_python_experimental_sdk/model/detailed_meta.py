...
class DetailedMeta(
    ...
    """
    summary_uuid = StrSchema
    description_uuid = StrSchema


    def __new__(
        cls,
        *args: typing.Union[dict, frozendict, ],
        summary_uuid: typing.Union[summary_uuid, Unset] = unset,
        description_uuid: typing.Union[description_uuid, Unset] = unset,
