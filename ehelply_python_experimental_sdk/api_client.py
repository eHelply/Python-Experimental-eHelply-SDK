...
from ehelply_python_experimental_sdk import rest
from ehelply_python_experimental_sdk.configuration import Configuration
from ehelply_python_experimental_sdk.exceptions import ApiTypeError, ApiValueError
from ehelply_python_experimental_sdk.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/1.1.109/python'
