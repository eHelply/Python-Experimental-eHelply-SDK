...
# body param
SchemaForRequestBodyApplicationJson = CategoryBase


request_body_category_base = api_client.RequestBody(
    content={
...
class CreateCategoryPlacesCategoriesPost(api_client.Api):
    ...
    def create_category_places_categories_post(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_category_base.serialize(body, content_type)
