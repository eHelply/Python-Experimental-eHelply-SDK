...
request_path_category_uuid = api_client.PathParameter(
    name="category_uuid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=CategoryUuidSchema,
    required=True,
)
...
class GetCategoryPlacesCategoriesCategoryUuidGet(api_client.Api):
